view: com_google_analytics_enhanced_ecommerce_impression_field_object_1 {
  sql_table_name: atomic.com_google_analytics_enhanced_ecommerce_impression_field_object_1 ;;
